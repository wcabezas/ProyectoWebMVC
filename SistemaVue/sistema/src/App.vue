  ...
  <v-app id="inspire">
        ...
        <template>
          ...
          <v-list-group>
            ...
            <template>
              <v-list-item :to="{name:''}">
                <v-list-item-action>
                  <v-icon color="grey">group_work</v-icon>
                </v-list-item-action>
          ...
          <v-list-group>
            ...
            <template>
              <v-list-item :to="{name:''}">
                <v-list-item-action>
                  <v-icon color="grey">engineering</v-icon>
                </v-list-item-action>
            ...
            <template>
              <v-list-item :to="{name:''}">
                <v-list-item-action>
                  <v-icon color="grey">insert_chart</v-icon>
                </v-list-item-action>
    ...
    <v-footer padless>
      <v-col class="text-right" cols="12">
        ...
        <strong>Contacto: Willian.cabezasroa@gmail.com</strong>
      </v-col>
    </v-footer>
  </v-app>
</template>
